	...
	var data = {
        ...
        **/
        "bandits-village-fouiller-reussite-texte-1" : {
        	...
        	eo : "La domoj estas malplenaj kaj neniu estas tie por haltigi vin."
        },
        "bandits-village-fouiller-reussite-texte-2" : {
        	...
        	eo : "Feliĉe, vi trovas la provizejon. Ĉi tiuj porvivaĵoj estos tre utila al vi!"
        },
        ...
        **/
        "bandits-village-fouiller-echec-texte-1" : {
        	...
        	en : "You search into all the houses, but in vain.",
        	eo : "Vi esploras ĉiujn domojn, sed vane."
        },
        "bandits-village-fouiller-echec-texte-2" : {
        	...
        	eo : "Nenio kaj neniu estas tie por haltigi vin, eĉ ne eta pomo&hellip;"
        },
        ...
        **/
        "bandits-village-fouiller-critique-texte-1" : {
        	...
        	eo : "En ĉiu domo esplorita, sama konstato: nenio."
        },
        "bandits-village-fouiller-critique-texte-2" : {
        	...
        	eo : "Vi alproksimiĝas la lasta domo, kiam vi aŭdas rikani malantaŭ vi."
        },
        "bandits-village-fouiller-critique-texte-3" : {
        	...
        	eo : "Almenaŭ, vi povos transdoni vian elrevigon al iu&hellip;"
        },
        ...
        **/
        "bandits-village-2-texte-1" : {
        	...
        	eo : "Esplirinta la lastan domon, vi reiras serĉi tiujn bandotijn."
        },
        "bandits-village-2-texte-2" : {
        	...
        	eo : "Bruoj en la vilaĝocentro indikas al vi la loko kie serĉi&hellip;"
        },
        ...
        "bandits-village-3-texte-1" : {
        	...
        	eo : "Vi diskrete observas la homamason kolektiĝitan malproksime."
        },
        "bandits-village-3-texte-2" : {
        	...
        	eo : "Kio okazas&nbsp;? Ŝajnas, ke ili ĉeestas la batalon."
        },
        ...
        **/
        "bandits-village-infiltrer-reussite-texte-1" : {
        	...
        	eo : "Vi integras la homamason kun la arto de la plej talentaj murdistoj."
        },
        "bandits-village-infiltrer-reussite-texte-2" : {
        	...
        	eo : "Kelkaj kapoj turniĝas al vi, sed la homamaso servas al vi kiel masko."
        },
        "bandits-village-infiltrer-reussite-texte-3" : {
        	...
        	eo : "Num je kejkaj metroj de la batalo, vi finfine povas ĝui la scenon&hellip;"
        },

        "bandits-village-observer-texte-1" : {
        	fr : "Vous ne pouvez retenir votre dégoût.",
        	en : "You can’t hold back you disgust.",
        	eo : "Vi ne povas reteni vian năuzon."
        },
        "bandits-village-observer-texte-2" : {
        	...
        	eo : "Du viroj malespere batalas kontraŭ malsata gulo."
        },
        "bandits-village-observer-texte-3" : {
        	...
        	eo : "Multaj dispercigita korpoj kuŝas sur la grundo servantaj kiel manĝaĵo por 3 aliaj guloj iom pli distrigemaj."
        },
        "bandits-village-observer-texte-4" : {
        	...
        	eo : "Trans la areno, bandito ŝajnanta pli nobla ol la aliaj, ĉeestas la scenon, amusita."
        },
        ...
        **/
        "bandits-village-infiltrer-2-reussite-texte-1" : {
        	...
        	eo : "Vi daŭrigas flirti inter la homamaso kiel plumo en la vento."
        },
        "bandits-village-infiltrer-2-reussite-texte-2" : {
        	...
        	eo : "Neniu ne rimarkas vin kaj vi nun alvenas al la pordoj de la reĝa loĝio."
        },
        "bandits-village-infiltrer-2-reussite-texte-3" : {
        	...
        	eo : "La plej riĉa bandito ĉirkaŭe estas nur al kelkaj metroj de vi&hellip;"
        },
        ...
        **/
        "bandits-village-roi-sannoncer-texte-1" : {
        	...
        	eo : "Via interparolanto turniĝas, surprizita."
        },
        "bandits-village-roi-sannoncer-texte-2" : {
        	...
        	eo : "&laquo;&nbsp;Nu! Vi imponas min, fremdulo. Tre malmultaj homoj havis la aŭdacon alproksimiĝi al mi, vi scias&hellip;&nbsp;&raquo;"
        },
        "bandits-village-roi-sannoncer-texte-3" : {
        	fr : "La foule, au loin, vous acclame.",
        	en : "The crowds, at the distance, cheers you.",
        	eo : "La homamaso, fore, aklamas vin."
        },
        "bandits-village-roi-sannoncer-texte-4" : {
        	...
        	eo : "&laquo;&nbsp;Kion vi pensas pri eta duelo ĝismorte? Tio estas tre banala, ĉu?&nbsp;&raquo;"
        },

        "bandits-village-roi-sannoncer-question-texte-1" : {
        	fr : "&laquo;&nbsp;Ne sois pas si prétentieux, héros&hellip; Tu ne gagneras pas&nbsp;!&nbsp;&raquo;",
        	en : "&laquo;&nbsp;Don’t be so pretentious, hero&hellip; You won’t win!&nbsp;&raquo;",
        	eo : "&laquo;&nbsp;Ne estus tiel pretendema, heroo&hellip; Vi ne gajnas!&nbsp;&raquo;"
        },
        ...
        "bandits-village-roi-sannoncer-refus-texte-1" : {
        	...
        	eo : "La reĝo ridegas kaj alproksimiĝas al vi."
        },
        "bandits-village-roi-sannoncer-refus-texte-2" : {
        	...
        	eo : "&laquo;&nbsp;Pardonu min, vi eble pensis, ke vi havis la elekton?&nbsp;&raquo;"
        },
        //bandits-village-roi-sannoncer-question-texte-3
        ...
        **/
        "bandits-village-infiltrer-2-echec-texte-1" : {
        	...
        	eo : "Vi daŭrigas diskrete alproksimiĝi, silente&hellip; Tamen, tro silente."
        },
        "bandits-village-infiltrer-2-echec-texte-2" : {
        	...
        	eo : "Unu el spektantoj, tro absorbita pri la spektaklo kaj ne vidanta vin, vi impetege tretas la piedojn."
        },
        ...
        "bandits-village-infiltrer-2-echec-2-texte-1" : {
        	...
        	eo : "La spektalo subite haltas kaj ĉiuj rigardoj turniĝas al vi."
        },
        "bandits-village-infiltrer-2-echec-2-texte-2" : {
        	...
        	eo : "&laquo;&nbsp;Nu, nu, kion ni havas tie? Ĉu knabineto estus inter ni?&nbsp;&raquo;"
        },
        ...
        "bandits-village-infiltrer-2-echec-2-texte-4" : {
        	...
        	eo : "&laquo;&nbsp;Alkonduku lin en la arenon miaj amikoj, ke ni iomete ridu.&nbsp;&raquo;"
        },
        "bandits-village-infiltrer-2-echec-2-texte-5" : {
        	...
        	eo : "Vi ne havas tempon por reagi, ke muskolaj brakoj kaptas vin de ĉie kaj ĵetas vin en la foson."
        },
        "bandits-village-infiltrer-2-echec-2-texte-6" : {
        	...
        	eo : "Ŝajnas, ke nur restas al vi defendi vin kontraŭ ĉiuj kreaĵoj&hellip;"
        },
        ...
        **/
        "bandits-village-infiltrer-echec-texte-1" : {
        	...
        	eo : "Vi diskrete antaŭeniras kiel ombro. Neniu rimarkas vin&hellip;"
        },
        "bandits-village-infiltrer-echec-texte-2" : {
        	...
        	eo : "Bedaŭrinde, je kelkaj paŝoj de la areno, vi stumblas sur granda ŝtono."
        },
        "bandits-village-infiltrer-echec-texte-3" : {
        	...
        	eo : "Rapide, tio estas nun interbatalo, kio komenciĝas en la homamaso!"
        },
        "bandits-village-infiltrer-echec-texte-4" : {
        	...
        	eo : "Ne tre diskreta ĉi tiu kaŝeniĝado&hellip;"
        },
        ...
        "bandits-village-infiltrer-echec-2-texte-1" : {
        	...
        	eo : "Vi liberigas de la ĝenulojn, sed 5 aliaj denove ĵetiĝas sur vi!"
        },
        "bandits-village-infiltrer-echec-2-texte-2" : {
        	...
        	eo : "Superŝutita per la nombro da atakantoj, vi estas devigita forkuri al la areno."
        },
        "bandits-village-infiltrer-echec-2-texte-3" : {
        	...
        	eo : "Almenaŭ, ĉi tie, la frenezaj spektantoj ne sekvos vin&hellip;"
        },
        ...
        **/
        "bandits-village-sannoncer-texte-1" : {
        	...
        	eo : "&laquo;&nbsp;Sed, kion ni havas tie miaj amikoj! Heroo degnas honori nin per sia ĉeesto!&nbsp;&raquo;"
        },
        ...
        "bandits-village-sannoncer-texte-3" : {
        	...
        	eo : "&laquo;&nbsp;Kion vi atendas por veni al mi?&nbsp;&raquo;"
        },
        "bandits-village-sannoncer-texte-4" : {
        	...
        	eo : "Post tiuj vortoj, la homamaso kaptas kaj puŝas vin al la pordoj de la foso."
        },
        "bandits-village-sannoncer-texte-5" : {
        	fr : "Le combat semble inévitable&hellip;",
        	en : "The fight seems inevitable&hellip;",
        	eo : "La batalo ŝajnas neevitebla&hellip;"
        },
        ...
        **/
        "bandits-village-contourner-texte-1" : {
        	...
        	eo : "Vi serĉas alian vojon, vane&hellip;"
        },
        "bandits-village-contourner-texte-2" : {
        	...
        	eo : "Ŝajnas, ke tiu homamaso estus deviga vojo."
        }
	};
