...
define([], function(){
	var data = {
        ...
        "nid-texte-3" : {
        	...
        	eo : "Rigardante ĝin bone, multaj <span key='araignee'>araneoj</span> kadavroj rekovras la grundon."
        },
        ...
        "nidDague-texte-2" : {
        	...
        	eo : "Granda <span key='poing'>pugno</span> kraŝas sur via vizaĝo kaj faras fali vin teren."
        },
        "nidDague-texte-3" : {
        ...
        "nid2-texte-1" : {
        	...
        	eo : "Rigardante ĝin bone, vi distingas <span key='bandit'>banditon</span>, kiu kaŝiĝas en la mallumo."
        },
        "nid2-texte-2" : {
        ...
        "nid3Fouille-texte-1" : {
        	...
        	eo : "Prirabante la prirabulo, vi trovas grandan pecon de <span key='fromage'>fromaĝon</span>!"
        },
        "nid3Fouille-texte-2" : {
        	fr : "Allez-vous vous régaler ou le garder sagement&nbsp;?",
        	en : "Are you going to enjoy it now or keep it wisely for later?",
        	eo : "Ĉu vi franĝos vin aŭ gardi ĝin saĝe?"
        },
        ...
        "nid3TrouveDague-texte-1" : {
        	...
        	eo : "Vi havas la bonan ideon de daŭrigi la serĉojn."
        },
