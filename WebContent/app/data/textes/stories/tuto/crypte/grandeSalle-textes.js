...
define([], function(){
	var data = {
        "necroGSFight-texte-1" : {
        	...
        	eo : "Vi eniras en tre grandan kripton."
        },
        "necroGSFight-texte-2" : {
        	...
        	en : "As your arrive, the place keeper, a <span key='grosseGoule'>big ghoul</span>, is heading for you.",
        	eo : "Je via alveno, la gardisto de la loko, <span key='grosseGoule'>gulego</span>, alproksimiĝas al vi."
        },
        "necroGSFight-texte-3" : {
        	...
        	eo : "Flanke, du <span key='squelette'>skeletoj</span> malrapide eliras el iliaj ĉerkoj&hellip;"
        },

        "necroGSFight2-texte-1" : {
        	fr : "Vous vous relevez péniblement après ce difficile combat.",
        	en : "You get up painfully after this difficult fight.",
        	eo : "Vi pene ekstaras post ĉi tiu malfacila batalo."
        },
        "necroGSFight2-texte-2" : {
        	...
        	eo : "Ankoraŭ ŝokita, vi observas la ĉambron ĉirkaŭ vi&hellip;"
        },
        ...
        "necroGSRoiFight-texte-1" : {
        	...
        	en : "The <span key='roiAraignee'>king of spiders</span> lies unconscious in the middle with a <span key='grosseGoule'>big dead ghoul</span> in his maw&hellip;",
        	eo : "La <span key='roiAraignee'>reĝo de la araneoj</span> kuŝas en la mezo, senkonscia, <span key='grosseGoule'>morta gulego</span> en la faŭko&hellip;"
        },

        "necroGSRoiFight2-texte-1" : {
        	fr : "Vous vous relevez péniblement après ce difficile combat et vous dirigez vers votre ami.",
        	en : "You get up up painfully after this difficult fight and you head for your friend.",
        	eo : "Vi pene ekstaras post ĉi tiu malfacila batalo kaj vi alproksimiĝas al via amiko."
        },
        "necroGSRoiFight2-texte-2" : {
        	fr : "Le roi, à l'agonie, vous exprime son dernier souhait&nbsp;:",
        	en : "The king, dying, expresses his last wish to you:",
        	eo : "La reĝo, agonianta, esprimas al vi sian lastan deziron:"
        },
        "necroGSRoiFight2-texte-3" : {
        	...
        	en : "&laquo;&nbsp;Thank you, noble adventurer. I'm dying&hellip; But you, you can still save your species.",
        	eo : "&laquo;&nbsp;Dankon, nobla aventurulo. Mi mortiĝas&hellip; Sed vi, vi povas ankoraŭ savi vian specon."
        },
        "necroGSRoiFight2-texte-4" : {
        	fr : "Vengez-nous, combattez pour l'araignée&nbsp;!&nbsp;&raquo;",
        	en : "Avenger us, fight for the spider!&nbsp;&raquo;",
        	eo : "Venĝu nin, batalu por la araneo!&nbsp;&raquo;"
        },
        "necroGSRoiFight2-texte-5" : {
        	fr : "Avant de mourir, le roi s'arrache un <span key='crocRoi'>croc</span> et le jette à vos pieds.",
        	en : "Before he dies, the king tears a <span key='crocRoi'>fang</span> off and throws it at your feet.",
        	eo : "Antaŭ ol morti, la reĝo eltiras <span key='crocRoi'>dentegon</span> kaj ĵetas ĝin ĉe viaj piedoj."
        },

        "necroGSFight3Oui-texte-1" : {
        	fr : "Vous prenez l'arme en souvenir de votre ami.",
        	en : "You take this weapon as a souvenir of your friend.",
        	eo : "Vi prenas la armilo memore al via amiko."
        },
        "necroGSFight3Oui-texte-2" : {
        	fr : "Elle fera certainement une alliée précieuse&nbsp;!",
        	en : "It will certainly be a precious ally!",
        	eo : "Ĝi certe estos granda aliancano!"
        },

        "necroGSFight3Non-texte-1" : {
        	fr : "Vous laissez l'arme devant votre ami.",
        	en : "You leave the fang in front of your friend.",
        	eo : "Vi lasas la armilo antaŭ via amiko."
        },
        "necroGSFight3Non-texte-2" : {
        	fr : "Espérant qu'elle l'accompagne dans l'au-delà.",
        	en : "Hoping that it will accompany him to the afterlife.",
        	eo : "Esperante, ke ĝi akompanos lin en la transmondo."
        },

        "necroGS-texte-1" : {
        	fr : "Vous vous trouvez dans une gigantesque salle aux allures de crypte.",
        	en : "You are in a huge room looking as a crypt.",
        	eo : "Vi estas en giganta ĉambro, kiu aspektas kiel kripto."
        },
        "necroGS-texte-2" : {
        	fr : "Quelques cercueils sont éparpillés un peu partout.",
        	en : "Some coffins are scattered all over the place.",
        	eo : "Kelkaj ĉerkoj estas disigitaj ĉie."
        },
        "necroGS-texte-3" : {
        	...
        	eo : "Vi rimarkas tri pordojn: maldekstre, fronte kaj dekstret&hellip;"
        },

        "necroGSFouilleCercueil-texte-1" : {
        	fr : "Avec dégoût, vous fouillez les cercueils.",
        	en : "With disgust, you search the coffins.",
        	eo : "Malinkline, vi priserĉas la ĉerkojn."
        },
        "necroGSFouilleCercueil-texte-2" : {
        	...
        	eo : "La du unuaj estas malplenaj, sed en la tria,"
        },
        "necroGSFouilleCercueil-texte-3" : {
        	fr : "vous apercevez une lueur jaune sous un tas d'os&hellip;",
        	en : "you notice a yellow glow under a pile of bones&hellip;",
        	eo : "vi ekvidas flavan lumon sub amaso de ostoj&hellip;"
        },
        ...
        "necroGSFouilleCercueil2-texte-1" : {
        	...
        	eo : "Vi prenas aŭtentikan <span key='elixir'>eliksiron/span>!"
        },
        "necroGSFouilleCercueil2-texte-2" : {
        	fr : "Malheureusement, vous n'êtes pas le seul sur le coup&hellip;",
        	en : "Unfortunately, you're not the only one on the case&hellip;",
        	eo : "Bedaŭrinde, vi ne estas sola en la afero."
        },
        "necroGSFouilleCercueil2-texte-3" : {
        	fr : "Une main osseuse vous tient fermement le poignet.",
        	en : "A bony hand firmly holds your wrist.",
        	eo : "Osta mano firme tenas vian manartikon."
        },
        "necroGSFouilleCercueil2-texte-4" : {
        	...
        	eo : "Vi subite malantaŭas, forprenante la nano kun vi,"
        },
        "necroGSFouilleCercueil2-texte-5" : {
        	...
        	eo : "dum <span key='squelette'>unubraka skeleto</span> malfacile eliras el lia ĉerko&hellip;"
        },

        "necroGSFouilleCercueil3-texte-1" : {
        	fr : "Vous vous débarrassez facilement de votre adversaire.",
        	en : "You easily get rid of your opponent.",
        	eo : "Vi facile liberigas de via kontraŭulon."
        },
        ...
        "necroGSFouilleSalle-texte-1" : {
        	...
        	en : "It’s a large room that looks like a crypt.",
        	eo : "Ĝ estas granda ĉambro, aspektante kiel kripto."
        },
        "necroGSFouilleSalle-texte-2" : {
        	fr : "Les murs sont suintants d'humidité et un froid intense la parcourt.",
        	en : "The walls oozes and an intense cold goes all over it.",
        	eo : "La muroj ŝvitas per humido kaj intensa malvarmo trairas ĝin."
        },
        "necroGSFouilleSalle-texte-3" : {
        	fr : "Deux torches se trouvent accrochées sur le mur du fond&hellip;",
        	en : "Two torches are hung up on the back wall&hellip;",
        	eo : "Du torĉoj estas kroĉitaj sur la muro fonde&hellip;"
        },

        "necroGSTorcheG-texte-1" : {
        	fr : "Vous vous approchez de la torche sur le mur de gauche.",
        	en : "You approach the torch on the left wall.",
        	eo : "Vi alproksimiĝas al la torĉo sur la maldekstra muro."
        },
        "necroGSTorcheG-texte-2" : {
        	fr : "Celle-ci est éteinte.",
        	en : "This one is off.",
        	eo : "Ĉi tiu estas malŝaltita."
        },
        "necroGSTorcheG-texte-3" : {
        	...
        	eo : "Ĉu vi pensas, ke estas mallume? Kial ne ŝalti ĝin?"
        },

        "necroGSTorcheD-texte-1" : {
        	fr : "Vous vous approchez de la torche sur le mur de droite.",
        	en : "You approach the torch on the right wall.",
        	eo : "Vi alproksimiĝas al la torĉo sur la dekstra muro."
        },
        "necroGSTorcheD-texte-2" : {
        	...
        	eo : "Ĉu vi pensas, ke estas malvarme? Kial ne iomete varmiĝi?"
        },
        ...
        "necroGSTorcheOK-texte-1" : {
        	...
        	eo : "Vi konscience ekbruligas la torĉo, zorgante ne bruligi vin."
        },
        "necroGSTorcheOK-texte-2" : {
        	fr : "Soudain, vous entendez un système d'engrenages s'enclencher&hellip;",
        	en : "Suddenly, you hear a gear system&hellip;",
        	eo : "Subite, vi aŭdas dentradojn sistemon&hellip;"
        },
        "necroGSTorcheOK-texte-3" : {
        	fr : "Il semblerait qu'une porte se soit ouverte quelque part.",
        	en : "It looks like a door has opened somewhere.",
        	eo : "Ŝajnas, ke pordo estus malfermiĝis ie."
        },
        ...
        "necroGSTorcheKO-texte-1" : {
        	...
        	eo : "Vi lansas vian plej belan <span key='bouleFeu'>fajrobulon</span>!"
        },
        "necroGSTorcheKO-texte-2" : {
        	...
        	eo : "̈Ĉi tiu forte eksplodas sur la muro kaj eksplodigas la torĉon."
        },
        "necroGSTorcheKO-texte-3" : {
        	fr : "Il ne reste plus qu'une vieille tige en souvenir.",
        	en : "There's only one old rod left as a souvenir.",
        	eo : "Nur restas malnova stangeto."
        },
        "necroGSTorcheKO-texte-4" : {
        	fr : "R.I.P la torche&hellip;",
        	en : "R.I.P the torch&hellip;",
        	eo : "Adiaŭ la torĉo&hellip;"
        },

        "necroGSTorcheAllume-texte-1" : {
        	fr : "La torche brille de mille feux&nbsp;!",
        	en : "The torch shines brightly!",
        	eo : "La torĉo intense brilas!"
        },
        "necroGSTorcheAllume-texte-2" : {
        	fr : "Ne la regardez pas trop longtemps, ça pourrait brûler&nbsp;!",
        	en : "Don't look at it too long, it could burn!",
        	eo : "Ne rigardu ĝin tro longe, tio povus bruli!"
        },

        "necroGSTorcheExplose-texte-1" : {
        	fr : "Une vieille tige carbonisée se dresse fièrement sur le mur.",
        	en : "An old carbonized rod stands proudly on the wall.",
        	eo : "Malnova bruligita stangeto fiere staras sur la muro."
        },
        "necroGSTorcheExplose-texte-2" : {
        	fr : "Elle n'avait pourtant rien fait de mal&hellip;",
        	en : "It had done nothing wrong yet&hellip;",
        	eo : "Tamen, ĝi faris nenion malbonan&hellip;"
        },

        "necroGSS2-texte-1" : {
        	fr : "Vous faites face à une petite porte fermée à clef.",
        	en : "You're facing a small locked door.",
        	eo : "Vi estas antaŭ malgranda ŝlosita pordo."
        },
        "necroGSS2-texte-2" : {
        	fr : "Elle semble très résistante&hellip;",
        	en : "It seems very resistant&hellip;",
        	eo : "Ŝajnas, ke ĝi estas tre rezista."
        },
        "necroGSS2-texte-3" : {
        	fr : "En tendant l'oreille, vous entendez des cris,",
        	en : "When you listen carefully, you hear some screams,",
        	eo : "Aŭskultante pli bone, vi aŭdas kriojn,"
        },
        "necroGSS2-texte-4" : {
        	fr : "comme si une personne essayait de se débattre.",
        	en : "like someone trying to struggle.",
        	eo : "kvazaŭ persono provas barakti."
        }
	};
