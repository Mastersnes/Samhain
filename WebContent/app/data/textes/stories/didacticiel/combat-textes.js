	...
	var data = {
        ...
        **/
        "didacticiel-finchoix-texte-1" : {
            ...
            eo : "&laquo;&nbsp;Bone! Nun, vi majstras la subtilecojn de la elektojn!"
        },
        "didacticiel-finchoix-texte-2" : {
            ...
            eo : "Ĉi tiu lernado estos utila por alfronti la periploj kiuj atendas vin!"
        },
        "didacticiel-finchoix-texte-3" : {
            ...
            eo : "Sed&hellip; Ĉu vi estos kapabla gardi memregado kiam la ago aperos antaŭ vin?&nbsp;&raquo;"
        },
        /**
        * Arrivé bandit
        **/
        "didacticiel-bandit-texte-1" : {
            ...
            eo : "&laquo;&nbsp;Hm&hellip; Permisu min pridubi tion&hellip;&nbsp;&raquo;"
        },
        "didacticiel-bandit-texte-2" : {
            ...
            eo : "Fore, mizera viro proksimiĝas. Li ŝajnas rankori vin&hellip;Tamen, vi nenio farinta lin&hellip;"
        },
        "didacticiel-bandit-texte-3" : {
        	...
        	eo : "&laquo;&nbsp;Ĉu vi vidas la bandito tie? Vera tedulaĉo, ne? Buĉu lin brutale kaj vi havos tute mian dankemecon!&nbsp;&raquo;"
        },
        ...
        **/
        ...
        "didacticiel-combat-texte-2" : {
        	...
        	eo : "Uzu la paperojn malsupren la ekranon por ataki lin.&nbsp;&raquo;"
        },
        ...
        "didacticiel-combat-texte-4" : {
        	...
        	eo : "Nun, tio estas via vico! Bonan ŝancon, juna padavano!&nbsp;&raquo;"
        },
        ...
        **/
        "didacticiel-win-texte-1" : {
        	...
        	eo : "La bandito faliĝas kaj forflugas en polvblovo."
        },
        ...
        "didacticiel-win-texte-3" : {
        	...
        	eo : "Vi bone memorita ĉiujn miajn instruadojn kaj nun, vi estas preta por la granda aventuro!"
        },
        ...
        **/
        ...
        "didacticiel-lose-texte-3" : {
        	...
        	eo : "&laquo;&nbsp;Nu! Vi sukcesis mortiĝi al la trejnado! Gratulon, tio ne estis facila&hellip;"
        },
        "didacticiel-lose-texte-4" : {
        	...
        	eo : "Aŭ vi posedas grandan paciencon, aŭ vi vere ne komprenas nenion pri la ludon. Ni esperu, ke temas pri la unua aserto."
        },
        "didacticiel-lose-texte-5" : {
        	...
        	eo : "Alie, revenu vidi me. Vi ne estas preta alfronti la mondo de ‘Samhain’!&nbsp;&raquo;"
        }
	};
